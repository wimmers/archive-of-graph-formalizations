theory Ports_Overview
  imports
    ...
    TA_Graph_to_DDFS
    "../Undirected_Graphs/Mitja/Walk" \<comment> \<open>Can't import whole formalization because of duplicate theory names\<close>
    Mitja_to_DDFS
begin
...
subsection \<open>Induces subgraphs\<close>
